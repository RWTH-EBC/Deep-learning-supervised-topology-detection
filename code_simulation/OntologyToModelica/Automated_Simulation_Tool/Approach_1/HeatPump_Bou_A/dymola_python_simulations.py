...
mod_name_A='HeatPump_Bou_A.mo' 


#-------------------------------------------------------------------------------------------------------------------------------------------

#From here on there are different examples of simulations with different input matrix (the name follows de Design of Experiments methodology)
...
#See how this functions work in script "simulations_functions.py"
...
list_output_results_try_2_taguchi, attempts_while_1_try_2_taguchi, attempts_while_2_try_2_taguchi, list_output_errors_try_2_taguchi=loop_simulations_try_2(mod_name_A, 
                                                                                                                                                          ...
                                                                                                                                                          dict_input_simulation_taguchi, 
                                                                                                                                                          simulation_name_taguchi)
#If the results of a simulations are saved in a subfolder inside the file. If not, replace r'\taguchi' with ''
