...
class Classifier_TLENET:
    ...
    def slice_data(self, data_x, data_y, length_sliced):
        ...
        increase_num = abs(length - length_sliced) + 1  # if increase_num =5, it means one ori becomes 5 new instances.
        # if increase_num < 0:
        #     increase_num = -increase_num
        n_sliced = n * increase_num
        # length_sliced = length_sliced if data_x.shape[1] > length_sliced else data_x.shape[1]
